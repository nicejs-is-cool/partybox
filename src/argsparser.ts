...
export default function argsParser(usageArgs: usageArg[], args: string) {
    let parsed = new Map<string, any>();
    ...
    function read_token(input: string, i: number, patterns: (string | RegExp)[][]): any {
    ...
    function tokenize(input: string, patterns: (string | RegExp)[][]) {
        var tokens = [];
