...
const fetchHandlers_1 = __importDefault(require("./utils/fetchHandlers"));
async function getPackageVersion() {
    let packageJson = await promises_1.default.readFile(path_1.default.join(__dirname, '../package.json'), 'utf8');
...
class Client extends events_1.default {
     ...
     * @returns {void} void
     */
    async connect(src = "trollbox.party") {
        this.src = src;
        ...
        await fetchHandlers_1.default(path_1.default.join(__dirname, "./handlers"))
            .then(handlers => {
            if (!handlers) {
